...
@Path("/") // optional for subresources: just '/', because path will be used from under getCommentResource()
...
public class CommentResource {
	...
	public Comment updateComment(@PathParam("messageId") long messageId,
			                     ...
			                     Comment comment) {
		comment.setId(commentId); // we need to do it here
	...
	@GET
	@Path("/{commentId}")
	public Comment getComment(@PathParam("messageId") long messageId, /* it's been taken from the parent resource */
			                 @PathParam("commentId") long commentId) {
